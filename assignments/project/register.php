<?php
// Include the database connection so we can interact with the acc table
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $sql = "SELECT id FROM acc WHERE username = :username OR email = :email";
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO acc (username, email, password)
